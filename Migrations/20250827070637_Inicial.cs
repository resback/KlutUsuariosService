    ...
    public partial class Inicial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BlackToken", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_IniciosSesion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_IniciosSesion_Usuarios_UsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlackToken_Jti",
                table: "BlackToken",
                column: "Jti",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_IniciosSesion_UsuarioId",
                table: "IniciosSesion",
                column: "UsuarioId");
